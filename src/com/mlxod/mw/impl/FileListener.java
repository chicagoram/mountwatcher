...
import com.mlxod.mw.impl.FileListener;
import com.mlxod.mw.arch.BaseListener;
import com.mlxod.mw.arch.IFileListener;
import com.mlxod.mw.util.AutoFileCloser;
...
public class FileListener extends BaseListener implements IFileListener {
	...
	public boolean moveFiletoNewDestination(File afile, String dest)
		...
		logger.info("Moving file...................... " + afile.getName()
				+ " to destination... " + dest);
		try {
		...
		logger.info("File........................... " + afile.getName()
				+ " moved successfully to " + dest + " folder!");
		...
		try {
			new AutoFileCloser() {
				...
				protected void doWork() throws Throwable {
					...
					logger.info("file just being processed............................"
							+ fr.getName());
					...
					if (success) {
						...
						while ((c = fs.readLine()) != null) {
							...
							logger.info(" Record.........................."
									+ tokens[0] + "  processed successfully");
			...
			synchronized (counterLock) {
				...
				logger.info("Total Records Processed.............................."
						+ Util.totRecords);
				logger.info("\n");
	...
	// inner class, generic extension filter
		public class GenericExtFilter implements FilenameFilter {
			...
			public boolean accept(File dir, String name) {
				...
				return (name.endsWith("swp") || name.endsWith("swx"));
			}
		}
}
